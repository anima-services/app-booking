...
const Connection = (props) => {
    ...
    async function getToken() {
        ...
        try {
            ...
            if (responseData["token"] != null) {
                ...
                setAuth(true);
                dispatch(updateData({ token: responseData["token"] }));
    ...
    async function getObjectData(in_id) {
        ...
        try {
            ...
            if (responseData["id"] != null) {
                dispatch(updateData({ [`space_${in_id}`]: responseData }));
    ...
    async function getMeetings(in_id) {
        ...
        try {
            ...
            if (responseData["results"] != null) {
                dispatch(updateData({ [`reservations_${in_id}`]: responseData["results"] }));
    ...
    async function getMap(in_id) {
        ...
        try {
            ...
            if (responseData != null) {
                dispatch(updateData({ mapData: responseData }));
    ...
    async function getUsers() {
        ...
        try {
            ...
            let responseData = await response.json();
            if (responseData["results"] != null) {
                dispatch(updateData({ usersData: responseData["results"] }));
...
export async function reservationCreate(in_hostname, in_token, in_id, in_start, in_end, in_user, in_topic, in_participants, in_update) {
    ...
    try {
        ...
        if (response.status > 299) {
            ...
            in_update({ text: 'Бронирование успешно создано!', color: Styles.main.free.borderColor });
        }
...
export async function reservationApprove(in_hostname, in_token, in_id, in_reserveToken, in_email, in_update) {
    ...
    try {
        ...
        if (response.status > 299) {
            ...
            in_update({ text: 'Бронирование успешно подтверждено!', color: Styles.main.free.borderColor });
        }
